<?php
/**
 * Template Name: Families & Homes Security
 */
get_header(); ?>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="text-3xl font-bold text-brand-navy mb-6">Home Security You Can Trust</h2>
                    <p class="text-gray-600 mb-6 text-lg">
                        Your home is your sanctuary. Our security solutions provide the protection you need to feel safe and secure, whether you're at home or away.
                    </p>
                    <ul class="space-y-4">
