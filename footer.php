...
<footer class="bg-gray-900 text-white pt-16 pb-8">
    <div class="container mx-auto px-4 md:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
                ...
                <div class="flex space-x-4">
                    <a class="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-brand-security transition" href="https://facebook.com/salesonthespot" target="_blank">
                    ...
                    <a class="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-brand-security transition" href="https://instagram.com/securityonthespotfl/" target="_blank">
            ...
            <div>
                ...
                <ul class="space-y-4 text-gray-400">
                    <li><a class="hover:text-white transition" href="<?php echo esc_url( home_url( '/' ) ); ?>">Home</a></li>
                    <li><a class="hover:text-white transition" href="<?php echo esc_url( home_url( '/who-we-are' ) ); ?>">About Us</a></li>
                    <li><a class="hover:text-white transition" href="<?php echo esc_url( home_url( '/contact-us' ) ); ?>">Contact Us</a></li>
                </ul>
            </div>
            <div>
            ...
            <div>
                <h4 class="font-bold text-lg mb-6">Work Hours</h4>
                <ul class="space-y-4 text-gray-400">
        ...
        <div class="border-t border-gray-800 pt-8 text-center text-sm text-gray-500">
            ...
            <p class="mt-2"><a href="https://toctoc.ky/" target="_blank" class="text-white hover:underline">Crafted with care by Toc Toc Marketing</a></p>
        </div>
    </div>
