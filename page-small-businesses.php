...
<main>
    ...
    <section class="relative pt-32 pb-20 bg-brand-navy overflow-hidden">
        <div class="absolute inset-0 opacity-20">
            <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80" alt="Small Business Security Miami" class="w-full h-full object-cover">
        </div>
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-3xl">
                <h1 class="text-4xl md:text-6xl font-bold text-white mb-6">Security Cameras for Miami Small Businesses</h1>
                <p class="text-xl text-blue-100 mb-8 leading-relaxed">
                    Affordable and reliable security solutions for local shops, boutiques, and offices. Protect your livelihood with professional CCTV installation.
                </p>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start space-x-3">
                            ...
                            <span class="text-gray-700 font-medium">Theft Deterrence: Visible cameras prevent shoplifting and vandalism.</span>
                        </li>
                        <li class="flex items-start space-x-3">
                            <div class="mt-1 bg-blue-100 p-1 rounded-full">
                                <svg class="w-4 h-4 text-brand-security" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            </div>
                            <span class="text-gray-700 font-medium">Employee Monitoring: Improve productivity and ensure safety protocols are followed.</span>
                        </li>
                        <li class="flex items-start space-x-3">
                            <div class="mt-1 bg-blue-100 p-1 rounded-full">
                                <svg class="w-4 h-4 text-brand-security" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            </div>
                            <span class="text-gray-700 font-medium">Evidence Collection: High-definition footage for insurance and legal purposes.</span>
                        </li>
                        <li class="flex items-start space-x-3">
                            <div class="mt-1 bg-blue-100 p-1 rounded-full">
                                <svg class="w-4 h-4 text-brand-security" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            </div>
                            <span class="text-gray-700 font-medium">Scalable Systems: Start small and expand as your business grows.</span>
                        </li>
                    </ul>
                </div>
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1556740738-b6a63e27c4df?auto=format&fit=crop&q=80" alt="Small Business Security Miami" class="rounded-3xl shadow-2xl">
        ...
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <div class="space-y-4">
                <div class="bg-white p-6 rounded-2xl shadow-sm">
                    ...
                    <p class="text-gray-600">We offer scalable solutions that fit any budget, ensuring you get the protection you need.</p>
                </div>
                <div class="bg-white p-6 rounded-2xl shadow-sm">
                    <h3 class="text-lg font-bold text-brand-navy mb-2">How long does installation take?</h3>
                    <p class="text-gray-600">Most small business installations are completed within a single day.</p>
                </div>
            </div>
        </div>
    </section>
