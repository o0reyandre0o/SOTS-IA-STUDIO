<?php
/**
 * Template Name: Home Automation Page
 */
get_header();
?>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4 md:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                    <h2 class="text-3xl font-bold text-brand-navy mb-6">Miami's Top-Rated Home Automation Installers</h2>
                ...
                <div class="relative hover-card">
                    ...
                    <div class="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hidden md:block">
                        ...
                        <div class="text-gray-500 text-xs uppercase font-bold">Integrated</div>
                    </div>
                </div>
            </div>
        </div>
