...
<main id="primary" class="site-main">
    ...
    <section class="py-12 bg-white border-b border-gray-100">
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60 grayscale hover:grayscale-0 transition duration-500">
                <img alt="Partner Logo" class="h-8" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCd_iQqVslxsiDSq-_X8LrTSasRfkMp0rD3nZK0L4d6OhuHRinNFoKDPwnnb7jWBv92U7Qjffl-DFABdUGe8Ru7-Neo1t9KBQ6tgTdH_dUWbQ7_QbEG7p14CDfUYMd3QnBUmB9cSwem-x3Kt_H1mVjo24YfK3OaHsLfSVDf6ga2ZTyTE8IBCoV0DRoOUtWADQ-aGiG81UIx-pHPBSrh4OOvYuMorRtKeL8bW7gX9DHUvNtgODEKbhIzQzNsCxu1cbzWmEQGWyEGyD8x">
                <img alt="Partner Logo" class="h-8" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAexWnInQIk2--6wKSE7_9fnuqBZT-WzKAoeoHv0Mu9lpOyeJ2BiyAQtJ-gPrfwf9pGYs8kM6vgPbHC5z4J_ptt7E0RX_5HajgRvf74_kwJVGZsO47zq-HnYUcirikAaA3RAZ59wEPPSjeV87NSm02K7OWEtNgZHeYLMZU_SojcSjpuZVtafcI33CK1dTiWFZYD28chy9PsjEbJysyoy6vV5kZ0PL2B_QQqD055yzmamhlunDlHNflLyDZ-aAtmi7uM-OAjzZW6iYM_">
                <img alt="Partner Logo" class="h-8" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDuRe6AwXLBxpLgo5mhoDtfNRIDhHL4nCxTdT1pYQ169q9Euy9qAtp5iTPElKy9fxju75bkKYYOMh1r8AGQqNMYtiOdYrN9xCLhG5C7bw5jVLx-vphBGuapiE4hm25IBrfmhDj8s8OiyP3_eiNUt6JdsB5yRsXWrTr8AmWOWCLj0-YVCPnXyIjEednzsYSzSW0ybEgVBjo2zJ8yb4v1ZW5CiFKqQuI0OAzB8AMqqTTl-gwZcwMhdVPACVmWl4fmzMkXmW2txXOZERUb">
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 md:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div class="text-center">
                    ...
                    <div class="text-xs text-blue-400 font-bold uppercase tracking-wider">Years Experience in Miami</div>
                </div>
                <div class="text-center">
                ...
                <div class="text-center">
                    ...
                    <div class="text-xs text-blue-400 font-bold uppercase tracking-wider">Local Support</div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 md:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
                ...
                <div class="p-8 bg-brand-light rounded-3xl border border-gray-100 hover:shadow-xl transition duration-300 group">
                    ...
                    <a href="<?php echo esc_url( home_url( '/security-cameras-security-on-the-spot' ) ); ?>" class="text-brand-security font-bold flex items-center">Learn More <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg></a>
                </div>
                ...
                <div class="p-8 bg-brand-light rounded-3xl border border-gray-100 hover:shadow-xl transition duration-300 group">
                    ...
                    <h3 class="text-xl font-bold text-brand-navy mb-4">Home Automation Near Me</h3>
                    ...
                    <a href="<?php echo esc_url( home_url( '/home-automation-smart-homes-in-miami' ) ); ?>" class="text-brand-security font-bold flex items-center">Learn More <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg></a>
                </div>
                ...
                <div class="p-8 bg-brand-light rounded-3xl border border-gray-100 hover:shadow-xl transition duration-300 group">
                    ...
                    <h3 class="text-xl font-bold text-brand-navy mb-4">Access Control Systems</h3>
                    ...
                    <a href="<?php echo esc_url( home_url( '/access-control' ) ); ?>" class="text-brand-security font-bold flex items-center">Learn More <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg></a>
                </div>
                ...
                <div class="p-8 bg-brand-light rounded-3xl border border-gray-100 hover:shadow-xl transition duration-300 group">
                    ...
                    <h3 class="text-xl font-bold text-brand-navy mb-4">Commercial Fire Alarms</h3>
                    ...
                    <a href="<?php echo esc_url( home_url( '/fire-systems' ) ); ?>" class="text-brand-security font-bold flex items-center">Learn More <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg></a>
                </div>
                ...
                <div class="p-8 bg-brand-light rounded-3xl border border-gray-100 hover:shadow-xl transition duration-300 group">
                    ...
                    <h3 class="text-xl font-bold text-brand-navy mb-4">Networking & Fiber</h3>
                    ...
                    <a href="<?php echo esc_url( home_url( '/networking-fiber-optics' ) ); ?>" class="text-brand-security font-bold flex items-center">Learn More <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg></a>
                </div>
                ...
                <div class="p-8 bg-brand-light rounded-3xl border border-gray-100 hover:shadow-xl transition duration-300 group">
                    ...
                    <h3 class="text-xl font-bold text-brand-navy mb-4">Audio & Video Services</h3>
                    ...
                    <a href="<?php echo esc_url( home_url( '/audio-video-services' ) ); ?>" class="text-brand-security font-bold flex items-center">Learn More <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg></a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="lg:w-1/2">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start space-x-4">
                            <div class="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-brand-security flex-shrink-0">
                            ...
                            <div>
                                <h4 class="font-bold text-brand-navy">Local Miami Experts</h4>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h4 class="font-bold text-brand-navy">Fast, Professional Installation</h4>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h4 class="font-bold text-brand-navy">3-Year Total Guarantee</h4>
    ...
    <section class="py-24 bg-brand-navy relative overflow-hidden text-center">
        <div class="container mx-auto px-4 relative z-10">
            ...
            <a href="<?php echo esc_url( home_url( '/contact-us' ) ); ?>" class="bg-brand-security hover:bg-brand-accent text-white px-12 py-6 rounded-full font-bold text-2xl transition shadow-xl inline-block">
